const menu = {
    admin: [
        ...
        'editsubject','fixchat', 'gcsider', 'grub', 'hidetag', 'kick', 'listabsen', 'listadmin', 'listalluser', 
    ...
    tools: [
        'cekdns','cekhost','cekuser','createqr','emojimix','get','google','git','hd','inspect','image','ipcheck','lorem','numberbot','detectqr','removebg','ssweb','tomp3','tourl','toimg','tom4a','translate','voicechanger','whois',
    ],
};
