...
/**
 * Fungsi utama untuk mencari karakter dari berbagai sumber.
 * Mencoba MyAnimeList dulu, jika gagal, coba Sonic Fandom Wiki.
 * @param {string} query Nama karakter yang dicari.
...
async function searchCharacter(query) {
    ...
    return character; // Mengembalikan hasil dari Fandom (bisa berupa objek atau null)
}
